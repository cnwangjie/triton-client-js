...
proto.inference.ModelInput.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isNonLinearFormatIo: jspb.Message.getBooleanFieldWithDefault(msg, 9, false)
  };
...
proto.inference.ModelInput.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setIsNonLinearFormatIo(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.inference.ModelInput.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getIsNonLinearFormatIo();
  if (f) {
    writer.writeBool(
      9,
      f
...
/**
 * optional bool is_non_linear_format_io = 9;
 * @return {boolean}
 */
proto.inference.ModelInput.prototype.getIsNonLinearFormatIo = function() {
 ...
 * @return {!proto.inference.ModelInput} returns this
 */
proto.inference.ModelInput.prototype.setIsNonLinearFormatIo = function(value) {
...
proto.inference.ModelOutput.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isShapeTensor: jspb.Message.getBooleanFieldWithDefault(msg, 6, false),
    isNonLinearFormatIo: jspb.Message.getBooleanFieldWithDefault(msg, 7, false)
  };
...
/**
 * optional bool is_non_linear_format_io = 7;
 * @return {boolean}
 */
proto.inference.ModelOutput.prototype.getIsNonLinearFormatIo = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 7, false));
};
 ...
 * @return {!proto.inference.ModelOutput} returns this
 */
proto.inference.ModelOutput.prototype.setIsNonLinearFormatIo = function(value) {
  return jspb.Message.setProto3BooleanField(this, 7, value);
};
...
proto.inference.ModelDynamicBatching.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readUint64, jspb.BinaryReader.prototype.readMessage, proto.inference.ModelQueuePolicy.deserializeBinaryFromReader, 0, new proto.inference.ModelQueuePolicy());
         });
      break;
    default:
      reader.skipField();
...
proto.inference.ModelDynamicBatching.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(7, writer, jspb.BinaryWriter.prototype.writeUint64, jspb.BinaryWriter.prototype.writeMessage, proto.inference.ModelQueuePolicy.serializeBinaryToWriter);
  }
};
...
/**
 * optional uint64 priority_levels = 4;
 * @return {number}
 */
...
/**
 * optional uint64 default_priority_level = 5;
 * @return {number}
 */
...
proto.inference.ModelSequenceBatching.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    iterativeSequence: jspb.Message.getBooleanFieldWithDefault(msg, 6, false)
  };
...
proto.inference.ModelSequenceBatching.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setIterativeSequence(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.inference.ModelSequenceBatching.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getIterativeSequence();
  if (f) {
    writer.writeBool(
      6,
      f
...
proto.inference.ModelSequenceBatching.State.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    useSameBufferForInputOutput: jspb.Message.getBooleanFieldWithDefault(msg, 6, false),
    useGrowableMemory: jspb.Message.getBooleanFieldWithDefault(msg, 7, false)
  };
...
proto.inference.ModelSequenceBatching.State.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setUseSameBufferForInputOutput(value);
      break;
    case 7:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setUseGrowableMemory(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.inference.ModelSequenceBatching.State.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getUseSameBufferForInputOutput();
  if (f) {
    writer.writeBool(
      6,
      f
  ...
  f = message.getUseGrowableMemory();
  if (f) {
    writer.writeBool(
      7,
      f
...
/**
 * optional bool use_same_buffer_for_input_output = 6;
 * @return {boolean}
 */
proto.inference.ModelSequenceBatching.State.prototype.getUseSameBufferForInputOutput = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 6, false));
};
 ...
 * @return {!proto.inference.ModelSequenceBatching.State} returns this
 */
proto.inference.ModelSequenceBatching.State.prototype.setUseSameBufferForInputOutput = function(value) {
  return jspb.Message.setProto3BooleanField(this, 6, value);
};


/**
 * optional bool use_growable_memory = 7;
 * @return {boolean}
 */
proto.inference.ModelSequenceBatching.State.prototype.getUseGrowableMemory = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 7, false));
};
 ...
 * @return {!proto.inference.ModelSequenceBatching.State} returns this
 */
proto.inference.ModelSequenceBatching.State.prototype.setUseGrowableMemory = function(value) {
  return jspb.Message.setProto3BooleanField(this, 7, value);
};
...
proto.inference.ModelSequenceBatching.StrategyOldest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    preserveOrdering: jspb.Message.getBooleanFieldWithDefault(msg, 4, false)
  };
...
/**
 * optional bool preserve_ordering = 4;
 * @return {boolean}
 */
proto.inference.ModelSequenceBatching.StrategyOldest.prototype.getPreserveOrdering = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.inference.ModelSequenceBatching.StrategyOldest} returns this
 */
proto.inference.ModelSequenceBatching.StrategyOldest.prototype.setPreserveOrdering = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
...
/**
 * optional bool iterative_sequence = 6;
 * @return {boolean}
 */
proto.inference.ModelSequenceBatching.prototype.getIterativeSequence = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 6, false));
};
 ...
 * @return {!proto.inference.ModelSequenceBatching} returns this
 */
proto.inference.ModelSequenceBatching.prototype.setIterativeSequence = function(value) {
  return jspb.Message.setProto3BooleanField(this, 6, value);
};
...
proto.inference.ModelEnsembling.Step.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    modelNamespace: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
...
/**
 * optional string model_namespace = 5;
 * @return {string}
 */
proto.inference.ModelEnsembling.Step.prototype.getModelNamespace = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.inference.ModelEnsembling.Step} returns this
 */
proto.inference.ModelEnsembling.Step.prototype.setModelNamespace = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
...
proto.inference.ModelConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    runtime: jspb.Message.getFieldWithDefault(msg, 25, ""),
...
/**
 * optional string runtime = 25;
 * @return {string}
 */
proto.inference.ModelConfig.prototype.getRuntime = function() {
 ...
 * @return {!proto.inference.ModelConfig} returns this
 */
proto.inference.ModelConfig.prototype.setRuntime = function(value) {
